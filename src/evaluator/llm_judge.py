...
5.0: The Generated Answer is accurately accurate, complete, and aligns entirely with the Ground Truth.
...
- 5.0: The context accurately contains the exact information needed.
...
- 5.0: Direct, concise, and accurately answers the specific question.
