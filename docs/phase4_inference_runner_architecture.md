...
This document details the architectural decisions made to simply support both scenarios within a unified data model.
...
When the subsequent *Evaluation Runner (Phase 5)* executes, its logic is simply simple:
